...
void ingreso(int &dividendo, int &divisor, char &op);
int calcular_cociente_resto(int dividendo, int divisor, char op);
main()
{
    int dividendo, divisor, valor;
    char op;

    ingreso(dividendo, divisor, op);

    valor = calcular_cociente_resto(dividendo, divisor, op);
...
void ingreso(int &dividendo, int &divisor, char &op)
{
    ...
    do
    {
        cout << "Ingrese opcion, [c]COCIENTE / [r]RESTO" << endl;
        cin >> op;
        opcion = (op == 'c') || (op == 'r');
    } while (!opcion);
    cout << "Se eligio opcion: " << op << endl;
}
...
int calcular_cociente_resto(int dividendo, int divisor, char op)
{
    ...
    {
    case 'c':
        cout << "Se eligio cociente." << endl;
        return cociente;
    case 'r':
        cout << "Se eligio resto." << endl;
        return dividendo;
    }
}